                            ...
                            <div class="col-sm-6">
                                <nav class="breadcrumb-two" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"><a href="{{ route('admin.admissions') }}">Admission</a></li>
                                    </ol>
                                </nav>
                            </div>
                            <div class="col-sm-6">
                            ...
                            @foreach($admissions as $contact)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.admission.show', $contact->id) }}" title="Edit" class="badge badge-primary viewPopUpModal"> <i data-feather="eye"></i></a>
                                        <a href="{{ route('admin.admission.delete', $contact->id) }}" title="Delete" class="badge badge-dark warning confirm"><i data-feather="archive"></i></a>
