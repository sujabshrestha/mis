                            ...
                            <div class="col-sm-6">
                                <nav class="breadcrumb-two" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"><a href="{{ route('admin.mail.sender') }}">Mail Sender </a></li>
                    ...
                    <div class="table-responsive mb-4 mt-4">
                        <table id="zero-config" class="table table-hover" style="width:100%">
                            ...
                            <tr>
                                ...
                                <td>{{ $activityLog->getExtraProperty('attributes')['designation']??'' }}</td>
