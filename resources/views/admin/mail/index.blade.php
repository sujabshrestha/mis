    ...
    <div class="layout-px-spacing">
        ...
        <div class="row layout-top-spacing">
            <div id="breadcrumbArrowed" class="col-xl-12 col-lg-12 layout-top-spacing mb-3">
                @include('admin.partials.breadcrumbs', ['type'=>'index', 'label'=>'Mail', 'route'=>'mail'])
            </div>
                            ...
                            @foreach($mails as $mail)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.user.edit', $mail->id) }}" title="Edit" class="badge badge-success"> <i data-feather="edit"></i></a>
                                        <a href="{{ route('admin.mail.delete', $mail->id) }}" title="Delete" class="badge badge-dark warning confirm"><i data-feather="archive"></i></a>
