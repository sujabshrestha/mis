                            ...
                            <div class="col-sm-6">
                                <nav class="breadcrumb-two" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"><a href="{{ route('admin.mail') }}">Mail Log</a></li>
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Logs</a></li>
                                    </ol>
                                </nav>
                            </div>
                            <div class="col-sm-6">
                                <a href="{{ route('admin.mail') }}" class="btn btn-sm btn-success float-right">Add New  </a>
                    ...
                    <div class="table-responsive mb-4 mt-4">
                        <table id="zero-config" class="table table-hover" style="width:100%">
                            ...
                            <tr>
                                ...
                                <td>{{ $activityLog->getExtraProperty('attributes')['name']??'' }}</td>
                                <td>{{ $activityLog->getExtraProperty('attributes')['mail_to']??'' }}</td>
