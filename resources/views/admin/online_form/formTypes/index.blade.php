                        ...
                        <table id="zero-config" class="table table-hover" style="width:100%">
                            ...
                            @foreach($forms as $form)
                                <tr>
                                    ...
                                    <td>{{ $form->title }}</td>
                                    <td>{{ $form->slug }}</td>
                                    <td>{{ $form->title_nepali }}</td>
                                    <td> @if($form->status == 1 ) <span class="badge badge-success">Active</span> @else <span class="badge badge-danger">Inactive</span> @endif</td>
                                    <td>

                                        <a href="{{ route('admin.form.edit',[$form->slug]) }}" title="Edit" class="badge badge-success"> <i data-feather="edit"></i></a>

                                        <a href="{{ route('admin.form.delete',[$form->id]) }}" title="Delete" class="badge badge-dark warning confirm"><i data-feather="archive"></i></a>
