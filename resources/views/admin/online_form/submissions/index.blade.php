                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>Form Submission List : {{$formType->title}} Form </h4>
                        </div>
                    </div>
                </div>
                <div class="widget-content widget-content-area br-6">
                    <div class="table-responsive mb-4 mt-4">
                        <table id="zero-config" class="table table-hover" style="width:100%">
                            ...
                            <tbody>
                            @if(isset($formUsers))
                                @foreach($formUsers->sortByDesc('created_at') as $user)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" title="view" class="badge badge-success"> <i data-feather="eye"></i></a>

                                            <a href="#" title="Delete" class="badge badge-dark warning confirm"><i data-feather="archive"></i></a>
