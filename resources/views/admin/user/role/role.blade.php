                            ...
                            <div class="col-sm-12">
                                <nav class="breadcrumb-two" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"><a href="{{ route('admin.user.role') }}">Role</a></li>
                        ...
                        <div class="widget-content widget-content-area br-6">
                            <div class="table-responsive mb-4 mt-4">
                                <table id="zero-config" class="table table-hover" style="width:100%">
                                    ...
                                    <a href="#" title="Edit" data-id="{{ $role->id }}" class="badge badge-success btn-edit-role"> <i data-feather="edit"></i></a>
                                    <a href="{{ route('admin.user.role.delete', $role->id) }}" title="Delete" class="badge badge-dark warning confirm"><i data-feather="archive"></i></a>
                                         <a href="#" title="Assign Permission" data-id="{{ $role->id }}" class="badge badge-primary btn-permission-role"> Permission</a>
                    ...
                    <div class="col-md-4">
                        <div class="widget-content widget-content-area br-6">
                            <div class="col-lg-12 col-12 mx-auto">
                                {!! Form::open(['url'=>route('admin.user.role.store'), 'enctype'=>'multipart/form-data', 'id'=>'saverole']) !!}
                                <div class="form-group">
                                    <p>Role Name<span class="text-danger">*</span></p>
                                    <label for="title" class="sr-only">Role Name</label>
                                    {{ Form::text('name',old('name')??$book->name??'',['class' => 'form-control','placeholder'=> 'Role Name...', 'required']) }}
                                ...
                                <div class="form-group">
                                    ...
                                    {{ Form::text('slug',old('slug')??$book->slug??'',['class' => 'form-control','placeholder'=> 'Role Slug...', 'required']) }}
...
<script>
    ...
    $(document).on("click", ".btn-edit-role", function (e) {
        ...
        var tempEditUrl = "{{ route('admin.user.role.edit', ':id') }}";
    ...
    var $modal = $('#roleModal');
    $(document).on("click", ".btn-permission-role", function (e) {
        e.preventDefault();
        var id = $(this).attr('data-id');
        var tempEditUrl = "{{ route('admin.user.role.permission', ':id') }}";
        tempEditUrl = tempEditUrl.replace(':id', id);
