...
<div class="container">
    <div class="row allpost">
        ...
        <div class="col-md-4" style="margin-top: 1%;">
            ...
            <article class="news-item content-area{{$service->id }}">
                    ...
                    <div class="inner-post radius-bottom">
                        <div class="entry-meta">
                            <span class="posted-on">
                                <time class="entry-date">{{ $service->created_at->format('Y-m-d') }}</time>
                            </span>
                        ...
                        <a class="post-link" href="{{ route('front.servicessingle',$service->slug) }}">Read more</a>
                    </div>
                </div>
            </article>
