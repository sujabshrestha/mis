                                ...
                                <header class="entry-header">
                                    <div class="entry-meta">
                                        <span class="posted-on">
                                            <time class="entry-date published">{{ $blog->created_at->format('Y-m-d') }}</time>
                                        </span>
                ...
                <aside id="sidebar" class="widget-area primary-sidebar col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <section id="recent_news-1" class="widget widget_recent_news">
                        ...
                        <ul class="recent-news clearfix">
                            ...
                            @foreach($posts->take(4)->skip(1) as $post)
                            <li class="clearfix ">
                                <div class="thumb">
                                    <a href="post.html">
                                ...
                                <div class="entry-header">
                                    ...
                                    <span class="post-on">
                                        <span class="entry-date">{{ $blog->created_at->format("Y-m-d") }}</span>
                                    </span>
                                </div>
                            </li>
                            @endforeach
