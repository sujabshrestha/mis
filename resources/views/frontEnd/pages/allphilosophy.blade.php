...
<div class="container">
    <div class="row allpost">
        <div class="allpost-head" style="margin-left: 1%;padding-top:2%;">
            <h2 class="section-title">All Philosophy</h2>
        </div>
        @if(isset($ourphilosophies)  && $ourphilosophies->count() > 0)
        @foreach($ourphilosophies as $ourphilosophy)
        <div class="col-md-4" style="margin-top: 1%;">

            <article class="news-item content-area{{$ourphilosophy->id }}">
                <div class="inner-item radius-top">
                    <div class="thumb-image">
                        <a href="#">
                            <img src="{{asset($ourphilosophy->image) }}" alt="" />
                        </a>
                    </div>
                    <div class="inner-post radius-bottom">
                        ...
                        <a class="post-link" href="{{ route('front.philosophySingle',$ourphilosophy->slug) }}">Read more</a>
                    </div>
                </div>
            </article>
