    ...
    <form method="post" action="{{ route('front.form.new-account.store') }}" enctype="multipart/form-data" class="open-form">
        ...
        <div class="form-header container">
            ...
            <div class="photo-upload">
                ...
                <input name="image_passport" type="file" id="upload-button" />
            </div>
        </div>
        <div class="form-content container">
            ...
            <div class="form-flex">
                <div class="form-group">
                    ...
                    <select name="" id="identity_type" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <input name="identity_no" type="text" class="form-control" />
                </div>
                <div class="form-group">
            ...
            <div class="form-flex">
                ...
                <div class="checkbox-wrap">
                    <input type="checkbox"  name="account-nature" value="personal"/>

                    <label for="">नीजि खाता / Personal Account</label>
                </div>
                <div class="checkbox-wrap">

                    <input type="checkbox" name="account-nature" value="joint" />

                    <label for="">संयुक्त खाता / Joint Account</label>
                </div>
                <div class="checkbox-wrap">

                    <input type="checkbox" name="account-nature" value="minor" />
                ...
                <div class="checkbox-wrap">
                    ...
                    <input type="checkbox" name="account-nature" value="other"/>
            ...
            <div class="form-flex">
                ...
                <div class="checkbox-wrap">
                    <input type="checkbox"  name="account-type" value="normal_saving"/>

                    <label for="">साधारण बचत / Normal Saving </label>
                </div>
                <div class="checkbox-wrap">

                    <input type="checkbox" name="account-type" value="naari_saving" />

                    <label for="">नारी बचत / Nari Bachat</label>
                </div>
                <div class="checkbox-wrap">

                    <input type="checkbox"  name="account-type" value="loan_saving"/>
            ...
            <div class="form-flex">
                <div class="checkbox-wrap">
                    ...
                    <input type="checkbox" name="account-type" value="hub_special_saving"/>

                    <label for="">ह्बविशेष बचत / Hub Special Saving </label>
                </div>
                <div class="checkbox-wrap">
                    <input type="checkbox"  name="account-type" value="baal_sikshya_saving"/>

                    <label for="">बलशिक्षा बचत / Bal Sikshya Bachat</label>
                </div>
                <div class="checkbox-wrap">

                    <input type="checkbox"  name="account-type" value="senior_citizen_saving"/>
            ...
            <div class="form-flex">
                <div class="checkbox-wrap">
                    ...
                    <input type="checkbox" name="account-type" value="loan_period_saving"/>
                ...
                <div class="checkbox-wrap">
                    ...
                    <input type="checkbox" name="account-type" value="other"/>
            ...
            <div class="form-flex">
                <div class="form-group">
                    ...
                    <input name="permanent_district" type="text" class="form-control" />
                </div>
                <div class="form-group">
                    <label for="">न.पा. / गा.वि.स. / VDC / Municipality</label>
                    <input name="permanent_municipality" type="text" class="form-control" />
                </div>
            </div>
            <div class="form-flex">
                <div class="form-group">
                    <label for="">वार्ड नं. / Ward No.</label>
                    <input name="permanent_ward" type="text" class="form-control" />
                </div>
                <div class="form-group">
                    <label for="">टोल / Tole </label>
                    <input name="permanent_tole" type="text" class="form-control" />
                </div>
            </div>
            ...
            <div class="form-flex">
                <div class="form-group">
                    <label for="">जिल्ला / District </label>
                    <input name="temporary_district" type="text" class="form-control" />
                </div>
                <div class="form-group">
                    <label for="">न.पा. / गा.वि.स. / VDC / Municipality </label>
                    <input name="temporary_municipality" type="text" class="form-control" />
                </div>
            </div>
            <div class="form-flex">
                <div class="form-group">
                    <label for="">वार्ड नं. / Ward No.</label>
                    <input name="temporary_ward" type="text" class="form-control" />
                </div>
                <div class="form-group">
                    <label for="">टोल  / Tole</label>
            ...
            <div class="form-flex">
                ...
                <div class="checkbox-wrap">
                    <input type="checkbox" name="statement" value="personally" />

                    <label for="">आफै लिनआउने / Personally Collect</label>
                </div>
                <div class="checkbox-wrap">

                    <input type="checkbox"  name="statement" value="post_box" />

                    <label for="">हुलाकमार्फत / By Post Box</label>
                </div>
                <div class="checkbox-wrap">

                    <input type="checkbox"  name="statement" value="english_calendar" />

                    <label for="">अंगे्रजीपात्रो अनुसार / In English Calendar</label>
                </div>
                <div class="checkbox-wrap">

                    <input type="checkbox" name="statement" value="nepali_calendar" />
            ...
            <div class="main-title">
                दस्तखत नमूना / Speciman Signature
            </div>
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
            ...
            <div class="form-flex">
                <div class="checkbox-wrap">
                    <input type="checkbox" name="account_instruction" value="single" />

                    <label for="">एकल / Single </label>
                </div>
                <div class="checkbox-wrap">

                    <input type="checkbox"  name="account_instruction" value="joint" />

                    <label for="">संयुक्त / Joint</label>
                </div>
                <div class="checkbox-wrap">

                    <input type="checkbox"  name="account_instruction" value="any_one" />

                    <label for="">कुनै एक / Any one</label>
                </div>
                <div class="checkbox-wrap">

                    <input type="checkbox"  name="account_instruction" value="any_two"  />

                    <label for="">कुनै दुई / Any Two</label>
                </div>
                <div class="checkbox-wrap">

                    <input type="checkbox"  name="account_instruction" value="any_three" />
                ...
                <div class="col-md-2">
                    <div class="photo-upload" style="padding-top: 30px;">
                        <div class="photo-wrapper">
                            <img id="upload_with_preview" class="img-fluid" />
                            <div class="photo-text">
                                परिचय गराउनेको फोटो <br>  Introducers Photo
                            </div>
                        </div>
                        ...
                        <div class="photo-upload " style="padding-top: 30px;">
                            <div class="photo-wrapper">
                                <img id="upload_with_preview" class="img-fluid" />
                                <div class="photo-text">
                                    इच्छाइएको व्यक्तिको फोटो  <br> Introducers Signature
                                </div>
                            </div>
