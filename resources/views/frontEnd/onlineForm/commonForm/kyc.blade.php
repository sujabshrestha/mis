        ...
        <div class="form-content container">
            ...
            <div class="form-flex">
                <div class="form-group">
                    ...
                    <input type="text" name="citizenship_no" required class="form-control" />
                </div>
                <div class="form-group">
            ...
            <div class="form-flex">
                ...
                <div class="form-group">
                    ...
                    <select name="family_type" class="form-control" >
                        <option value="joint/same-kitchen">संयुक्त र एकै भान्छा </option>
                        <option value="joint/diff-kitchen">संयुक्त तर अलग भान्छा</option>
                        <option value="nuclear"> छुिट्टभिन्न वाएकसरुवा (न्युक्लियर)</option>
                    </select>
                </div>
            ...
            <div class="form-flex">
                <div class="form-group">
                    ...
                    <div class="checkbox-wrap">
                        <input type="radio" name="is_family_member_higher_position" value="1"  />

                        <label for="">रहेको </label>
                    </div>
                    <div class="checkbox-wrap">

                        <input type="radio" name="is_family_member_higher_position" value="0"  />
            ...
            <div class="form-flex">
                <div class="form-group">
                    ...
                    <select name="permanent_province" onchange="pradeshChange(this)" data-target="permanent_district" data-child="permanent_municipal" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <select name="permanent_district"  class="form-control" onchange="districtChange(this)" data-target="permanent_municipal" id="permanent_district">
                        <option value="">Select District</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="">न.पा. / गा.वि.स. / VDC / Municipality</label>
                    <select name="permanent_municipal"  class="form-control" id="permanent_municipal">\
            ...
            <div class="form-flex">
                <div class="form-group">
                    ...
                    <input name="permanent_ward" type="number" class="form-control" />
                </div>
                <div class="form-group">
            ...
            <div class="form-flex">
                ...
                <div class="checkbox-wrap">
                    <input type="checkbox" name="residence_of_organization" value="temporary"  />

                    <label for="">अस्थायी</label>
                </div>
                <div class="checkbox-wrap">

                    <input type="checkbox"  name="residence_of_organization" value="permanent" />
            ...
            <div class="form-flex">
                ...
                <div class="form-group">
                    ...
                    <div class="checkbox-wrap">
                        <input type="radio" name="invlove_in_other_organization" value="1"  />

                        <label for="">भएको </label>
                    </div>
                    <div class="checkbox-wrap">

                        <input type="radio" name="invlove_in_other_organization" value="0"  />
            ...
            <div class="form-group">
                ...
                <div class="checkbox-wrap">
                    <input type="radio" name="other_family_involved" value="1"  />

                    <label for="">भएको   </label>
                </div>
                <div class="checkbox-wrap">

                    <input type="radio" name="other_family_involved" value="0"   />
            ...
            <div class="form-flex">
                <div class="form-group">
                    <label for="">संस्थाको नाम  </label>
                    <input type="text" name="other_family_involved_organization_name" class="form-control" />
                </div>
                <div class="form-group">
                    <label for="">ठेगाना         </label>
                    <input type="text" name="other_family_involved_organization_address" class="form-control" />
                </div>
                <div class="form-group">
                    <label for="">सदस्यता नं.</label>
                    <input type="text" name="other_family_involved_organization_no" class="form-control" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="checkbox-wrap">
                    <input type="radio" name="family_in_this_organization" value="1" />

                    <label for=""> भएको</label>
                </div>
                <div class="checkbox-wrap">

                    <input type="radio" name="family_in_this_organization"  value="0" />
            ...
            <div class="form-flex">
                ...
                <div class="checkbox-wrap">
                    <input name="family_income" type="radio" value="4" />

                    <label for="">४ लाखसम्म</label>
                </div>
                <div class="checkbox-wrap">

                    <input name="family_income" type="radio" value="10" />

                    <label for="">४ लाखभन्दा बढी रु. १० लाखसम्म</label>
                </div>
                <div class="checkbox-wrap">

                    <input name="family_income" type="radio" value="25" />

                    <label for="">१० लाखभन्दा बढी रु. २५ लाखसम्म</label>
                </div>
                <div class="checkbox-wrap">

                    <input name="family_income" type="radio" value="50" />
